...
public class OSRMRoadManager extends RoadManager {
	...
	static {
		...
		directions.put("0","Istruzione sconosciuta<  %s>");
		directions.put("1","Prosegui< in direzione %s>");
		directions.put("2","svolta leggermente a destra<verso %s>");
		directions.put("3","Svolta a destra< e imbocca %s>");
		directions.put("4","Svolta tutto a destra<e imbocca %s>");
		directions.put("5","Fai inversione a U<e ritorna in %s>");
		directions.put("6","Svolta tutto a sinistra<e imbocca %s>");
		directions.put("7","Svolta a sinistra<e imbocca %s>");
		directions.put("8","Svolta leggermente a sinistra<verso %s>");
		directions.put("9","Hai raggiunto una tappa del tuo percorso");
		directions.put("10","<Entra in %s>");
		directions.put("11-1","Alla rotonda prendi la prima uscita<e imbocca %s>");
		directions.put("11-2","Alla rotonda prendi la seconda uscita<e imbocca %s>");
		directions.put("11-3","Alla rotonda prendi la terza uscita<e imbocca %s>");
		directions.put("11-4","Alla rotonda prendi la quarta uscita<e imbocca %s>");
		directions.put("11-5","Alla rotonda prendi la quinta uscita<e imbocca %s>");
		directions.put("11-6","Alla rotonda prendi la sesta uscita<e imbocca %s>");
		directions.put("11-7","Alla rotonda prendi la settima uscita<e imbocca %s>");
		directions.put("11-8","Alla rotonda prendi la ottava uscita<e imbocca %s>");
		directions.put("11-9","Alla rotonda prendi la nona uscita<e imbocca %s>");
