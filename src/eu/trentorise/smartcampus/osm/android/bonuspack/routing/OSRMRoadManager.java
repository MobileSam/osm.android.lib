...
public class OSRMRoadManager extends RoadManager {
	...
	static {
		...
		directions.put("2","Tournez légèrement �  droite< sur %s>");
		...
		directions.put("8","Tournez légèrement �  gauche< sur %s>");
		directions.put("9","Vous êtes arrivé �  une étape de votre voyage");
