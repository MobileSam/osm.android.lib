...
import eu.trentorise.smartcampus.osm.android.views.overlay.IOverlayMenuProvider;
import eu.trentorise.smartcampus.osm.android.views.overlay.Overlay.Snappable;
import eu.trentorise.smartcampus.osm.android.views.overlay.SafeDrawOverlay;
        ...
        IOverlayMenuProvider, Snappable
{
    ...
    protected Rect getMyLocationDrawingBounds(int zoomLevel, Location lastFix, Rect reuse)
    {
        ...
        if (lastFix.hasBearing()) {
            ...
            int widestEdge = (int) Math.ceil(Math.max(mDirectionArrowBitmap.getWidth(),
                    mDirectionArrowBitmap.getHeight())
                    * Math.sqrt(2));
    ...
    /**
     * Enables "follow" functionality. The map will center on your current location and automatically scroll
